...
public class Fibonacci {
	...
	public static void main(String[] args) {
		...
		*/
		...
		//System.out.println(inverseFib(3));
	...
	public static double summatory() {
		...
		for(int i = 1;i<fibMap.size();i++) {
			sum += (1/fibMap.get(String.valueOf(i)));
			
			System.out.println(fibMap.get(String.valueOf(i)));
		}
		...
		System.out.println((1/fibMap.get(String.valueOf(3))));
